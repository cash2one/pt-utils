...
#   1. copy remote python packge to local
#   2. install new ubsutils.
#   2. back up the remote python package
...
echo "installing python ubsutils"
$local_python_dir/bin/python setup.py install

cd $local_python_dir/
tar -czf $package.new.tar.gz ./bin ./include ./lib 
